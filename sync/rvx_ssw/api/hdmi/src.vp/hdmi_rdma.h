#ifndef __HDMI_RDMA_H__
#define __HDMI_RDMA_H__
...
#define VOM_FRAMEBUFFER0    (DISPLAY_MEMORY_ADDR)
#define VOM_FRAMEBUFFER1    (DISPLAY_MEMORY_ADDR + DISPLAY_MEMORY_SIZE)

// HDMI TX�� ���� �޸𸮿��� RGBToDVI ���� �����͸� �־��ִ� ������ ��.

//#define HDMIRDMA_BASE	0x61000000  // RV-O1S
#define HDMIRDMA_BASE	0x97000000  // RV-R1N
